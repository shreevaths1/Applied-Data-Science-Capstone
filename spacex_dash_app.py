...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values=list(filtered_df.value_counts().values), 
        names=[0,1],
...
def get_scatter_chart(entered_site,slider_range):
    ...
    if entered_site == 'ALL':
        ...
        title='Correlation between Payload ans Success for all sites')
        return fig
    else:
        fig = px.scatter(filtered_df[mask],x='Payload Mass (kg)',y='class',color='Booster Version Category',
        title='Correlation between Payload ans Success for site '+entered_site)
        return fig
